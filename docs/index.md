...
[Releases](https://github.com/kazurayam/katalon-studio-texts-diff/releases) page.
...
It is difficult to read in a plain text editor. You would definitely need a Markdown viewer. [Visual Studio Code, Markdown Preview](https://code.visualstudio.com/Docs/languages/markdown#_markdown-preview) will let you handle any Markdown texts very nicely,like this:
